...
try {
    ...
    $mail->Body = '<div style="font-family:Arial;max-width:600px;margin:auto;border:1px solid #ddd;border-radius:8px;overflow:hidden">' .
        ...
        '<a href="' . $reset_link . '" style="background:#1A56A0;color:#fff;padding:12px 24px;border-radius:4px;text-decoration:none">Réinitialiser</a></div></div>';
    $mail->AltBody = "Copiez ce lien pour réinitialiser votre mot de passe : " . $reset_link;
    $mail->send();
